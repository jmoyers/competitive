...
class Solution:
    def subdomainVisits(self, list: List[str]) -> List[str]:
        result = {}
...
def test_lc1():
    ...
    assert set(Solution().subdomainVisits(inp)) == out
...
def test_lc2():
    ...
    result = Solution().subdomainVisits(inp)
    out = sorted(out)
